    ...
    <section id="education" className="relative">
      <div className="section-container" ref={sectionRef}>
        ...
        <div className="relative max-w-3xl mx-auto" ref={timelineRef}>
          <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-indigo-400/40 via-purple-400/30 to-transparent" />

          <div className="space-y-8">
            {t.education.items.map((item, i) => (
              <div key={i} data-animate className="relative pl-12">
                <div className="absolute left-[10px] top-6 w-3 h-3 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 shadow-lg shadow-indigo-500/40" />

                <div className="glass-card p-6 group">
                  <div className="flex items-start justify-between gap-4 mb-2">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200/50 dark:border-indigo-500/20 flex items-center justify-center flex-shrink-0">
                        <i className={`fas ${item.icon} text-indigo-500`} />
                      </div>
                      <div>
                        ...
                        <p className="text-indigo-600 dark:text-indigo-400 text-sm font-medium">{item.school}</p>
                      </div>
                    </div>
